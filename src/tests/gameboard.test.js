...
describe.only("Checking placeVerticalShip function for Ship length 3", () => {
...
describe.only("Checking placeVerticalShip function for Ship length 4", () => {
...
describe.only("Checking placeVerticalShip function for Ship length 5", () => {
...
//     ).toEqual(true);
//     expect(
//       gameboard.placeHorizontalShips([0, 4], myFirstShip, "horizontal")
//     ).toEqual(true);
//     //Checking to see if the ship can be placed in another coordinate. It can't because the length is 2 and i am trying to get the 3rd index filled.
//     expect(
//       gameboard.placeHorizontalShips([0, 7], myFirstShip, "horizontal")
...
//     expect(
//       gameboard.directionOfShips([0, 5], myFirstShip, "horizontal")
//     ).toEqual(false);
//   });
// });
...
//     ).toEqual(true);
//     expect(
//       gameboard.directionOfShips([0, 2], myFirstShip, "horizontal")
//     ).toEqual(true);
...
//     ).toEqual(true);
//     expect(
//       gameboard.directionOfShips([0, 3], myFirstShip, "horizontal")
//     ).toEqual(true);
...
//     ).toEqual(true);
//     expect(
//       gameboard.directionOfShips([0, 4], myFirstShip, "horizontal")
//     ).toEqual(true);
...
//     const myFirstShip = Ship(2);
//     expect(gameboard.directionOfShips([4, 4], myFirstShip, "vertical")).toEqual(
//       true
//     );
//     expect(gameboard.directionOfShips([5, 4], myFirstShip, "vertical")).toEqual(
//       true
//     );
