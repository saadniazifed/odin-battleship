...
test("Placing a Water Carrier Ship at a specific coordinate", () => {
  expect(Gameboard().placeShip().placeWaterCarrier(0, 0)[0][0]).toEqual(
    "Water Carrier"
  );

  expect(Gameboard().placeShip().placeWaterCarrier(0, 1)[1][0]).toEqual(
    "Water Carrier"
  );

  expect(Gameboard().placeShip().placeWaterCarrier(0, 2)[2][0]).toEqual(
    "Water Carrier"
  );

  expect(Gameboard().placeShip().placeWaterCarrier(0, 3)[3][0]).toEqual(
    "Water Carrier"
  );

  expect(Gameboard().placeShip().placeWaterCarrier(0, 4)[4][0]).toEqual(
    "Water Carrier"
  );
});
...
test("Placing a Submarine Ship at a specific coordinate", () => {
  expect(Gameboard().placeShip().placeSubmarine(0, 3)[3][0]).toEqual(
    "Submarine"
  );

  expect(Gameboard().placeShip().placeSubmarine(0, 4)[4][0]).toEqual(
    "Submarine"
  );
});

test("Placing a Patroller Ship at a specific coordinate", () => {
  expect(Gameboard().placeShip().placePatroller(0, 3)[3][0]).toEqual(
    "Patroller"
  );

  expect(Gameboard().placeShip().placePatroller(0, 4)[4][0]).toEqual(
    "Patroller"
  );
});
