...
describe("Testing the isSunk function in the ship of length 3", () => {
  test("Testing hit function", () => {
    const myFirstShip = Ship(3);
    myFirstShip.hit();
    myFirstShip.hit();
...
describe("Testing the isSunk function in the ship of length 4", () => {
  test("Testing hit function", () => {
    const myFirstShip = Ship(4);
    myFirstShip.hit();
    myFirstShip.hit();
...
describe("Testing the isSunk function in the ship of length 5", () => {
  test("Testing hit function", () => {
    const myFirstShip = Ship(5);
    myFirstShip.hit();
    myFirstShip.hit();
